...
@section('title', 'Categorías de Productos - Minaati Dashboard')
@section('meta_description', 'Gestión de categorías de productos del restaurante')
    ...
    <div class="col-lg-12 col-xl-12">
        <div class="card m-b-30">
            <div class="card-header">
                <h5 class="card-title">Lista de Categorías de Productos</h5>
            </div>
            <div class="card-body">
                <!-- Filtros -->
                <div class="row mb-3">
                ...
                <div class="table-responsive">
                    <table class="table table-borderless">
                        ...
                        <tbody id="tableBody">
                            @include('producto-categorias.partials.table-body')
                        </tbody>
                    </table>
                </div>
...
$(document).ready(function() {
    ...
    $('#createForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '{{ route("producto-categorias.store") }}',
            method: 'POST',
            data: $(this).serialize(),
            headers: {
    ...
    $('#confirmDelete').on('click', function() {
        if (deleteId) {
            $.ajax({
                url: `/producto-categorias/${deleteId}`,
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
    ...
    function loadTable(url = null) {
        let searchUrl = url || '{{ route("producto-categorias.index") }}';
