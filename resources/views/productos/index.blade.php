...
@section('title', 'Productos - Minaati Dashboard')
@section('meta_description', 'Gestión de productos del restaurante')
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-borderless">
                        ...
                        <tbody id="tableBody">
                            @include('productos.partials.table-body')
                        </tbody>
                    </table>
                </div>
            ...
            <form id="createForm">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="create_idcategoriaproductos">Categoría *</label>
                                <select class="form-control" id="create_idcategoriaproductos" name="idcategoriaproductos" required>
            ...
            <form id="editForm">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="edit_idcategoriaproductos">Categoría *</label>
                                <select class="form-control" id="edit_idcategoriaproductos" name="idcategoriaproductos" required>
                                    <option value="">Seleccione una categoría</option>
                                    @foreach($categorias as $categoria)
                                        <option value="{{ $categoria->id }}">{{ $categoria->nombre }}</option>
                                    @endforeach
...
$(document).ready(function() {
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                if (errors) {
                    ...
                    new Notyf().error('Error al crear el producto');
                }
            }
        });
    });
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    $('#edit_idcategoriaproductos').val(data.idcategoriaproductos);
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                if (errors) {
                    ...
                    new Notyf().error('Error al actualizar el producto');
                }
            }
        });
    });
    ...
    $('#confirmDelete').on('click', function() {
        if (deleteId) {
            $.ajax({
                ...
                error: function(xhr) {
                    let message = xhr.responseJSON?.message || 'Error al eliminar el producto';
    ...
    function loadTable(url = null) {
        let searchUrl = url || '{{ route("productos.index") }}';
