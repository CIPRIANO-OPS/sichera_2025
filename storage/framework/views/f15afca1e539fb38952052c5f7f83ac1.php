<div class="topbar">
                        ...
                        <div class="profilebar">
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="#" role="button" id="profilelink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img src="<?php echo e(asset('assets/images/users/avatar-1.jpg')); ?>" class="img-fluid" alt="profile">
                                    <span class="live-icon"><?php echo e(Auth::user()->name ?? 'Usuario'); ?></span>
                                    <i class="ri-arrow-down-s-line"></i>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profilelink">
                                    <div class="dropdown-item">
                                        <div class="profilename">
                                            <h5><?php echo e(Auth::user()->name ?? 'Usuario'); ?></h5>
                                            <p><?php echo e(Auth::user()->email ?? 'usuario@ejemplo.com'); ?></p>
                                        </div>
                                    </div>
                                    <div class="userbox">
                                        <ul class="list-unstyled mb-0">
                                            <li class="media dropdown-item">
                                                <a href="<?php echo e(route('profile.edit')); ?>" class="profile-icon">
                                                    <i class="ri-user-line"></i>
                                                </a>
                                                <div class="media-body">
                                                    <h5 class="mt-0 mb-0"><a href="<?php echo e(route('profile.edit')); ?>">Mi Perfil</a></h5>
    ...
    <!-- End row -->
</div><?php /**PATH D:\proyectos_php\sichera_2025\resources\views/layouts/partials/topbar.blade.php ENDPATH**/ ?>